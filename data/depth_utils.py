...
# def load_depth_velodyne(fname):
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D

if __name__ == '__main__':
    kitti_dir = "/home/chen-tian/data/data/KITTI/raw/"
    test_files = {"2011_09_26/2011_09_26_drive_0002_sync/image_00/data/0000000001.png"}
    gt_files, gt_calib, im_sizes, im_files, cams = \
        read_file_data(test_files, kitti_dir)

    pts = load_velodyne_points(gt_files[0])

    print read_text_lines(gt_calib[0] + 'calib_cam_to_cam.txt')

    # fig = plt.figure()
    # ax = fig.add_subplot(111, projection='3d')
    # ax.scatter(pts[:,0],pts[:,1],pts[:,2], 'r*')
    #
    # plt.show()
